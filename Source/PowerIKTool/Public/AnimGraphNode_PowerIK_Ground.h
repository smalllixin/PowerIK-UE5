...
#include "AnimGraphNode_PowerIK_Ground.generated.h"

UCLASS(MinimalAPI)
class UAnimGraphNode_PowerIK_Ground : public UAnimGraphNode_SkeletalControlBase
{
	GENERATED_UCLASS_BODY()

	UPROPERTY(EditAnywhere, Category = Settings)
	FAnimNode_PowerIK_Ground Node;
